...
export const listquota = apicall.get("/config/listquota", "Failed to list quota info");
...
export const listeventlog= apicall.get("/event/list", "Failed to list event logs info");