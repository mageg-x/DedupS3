  ...
  <div class="buckets-container">
    ...
    <div class="buckets-list-container">
      <div class="buckets-list">
        <!-- 桶列表 -->
        <div v-if="paginatedBuckets.length > 0" class="space-y-4">
          <div 
            v-for="(bucket, index) in paginatedBuckets" 
            :key="bucket.name"
          ...
          >
            ...
            <div class="bucketMetrics px-4 pb-4 flex items-center">
              <a href="#" class="flex-shrink-0 mr-6" @click.prevent="navigateToBucket(bucket.name)">
                <svg xmlns="http://www.w3.org/2000/svg" class="bucketIcon" fill="currentcolor" viewBox="0 0 256 256" style="height: 48px; width: 48px;">
                  <g>
                ...
                <div class="metric">
                  <svg xmlns="http://www.w3.org/2000/svg" class="min-icon" fill="currentcolor" viewBox="0 0 256 256">
                    ...
                    <g data-name="Reported Usage" clip-path="url(#prefix__a)">
                      ...
                      <path data-name="Trazado 390" d="M128.003 0a128.151 128.151 0 0 0-128 128c0 70.573 57.424 127.995 128 127.995a128.147 128.147 0 0 0 128-127.995 128.15 128.15 0 0 0-128-128Zm0 223.078a95.188 95.188 0 0 1-95.085-95.075 95.191 95.191 0 0 1 95.085-95.084v95.084h95.075a95.184 95.184 0 0 1-95.075 95.074Z"/>
...
// 模拟的桶数据
const buckets = ref([
  { name: 'production-data', objectCount: 12543, size: 54321098765, createdAt: '2023-05-15T10:30:00Z' },
  { name: 'backup-archive', objectCount: 8765, size: 12345678901, createdAt: '2023-04-22T14:15:00Z' },
  { name: 'user-uploads', objectCount: 23456, size: 89765432109, createdAt: '2023-06-01T09:45:00Z' },
  { name: 'analytics-data', objectCount: 5678, size: 34567890123, createdAt: '2023-03-10T16:20:00Z' },
  { name: 'media-storage', objectCount: 18902, size: 78901234567, createdAt: '2023-05-28T11:05:00Z' },
  { name: 'log-files', objectCount: 9876, size: 19876543210, createdAt: '2023-02-18T15:30:00Z' },
  { name: 'temp-storage', objectCount: 3456, size: 5678901234, createdAt: '2023-06-10T08:15:00Z' },
  { name: 'cdn-assets', objectCount: 15678, size: 67890123456, createdAt: '2023-04-05T13:40:00Z' },
  { name: 'database-backup', objectCount: 4321, size: 23456789012, createdAt: '2023-05-01T00:00:00Z' },
  { name: 'test-data', objectCount: 7890, size: 1234567890, createdAt: '2023-06-15T10:25:00Z' },
  { name: 'archive-2023', objectCount: 11234, size: 45678901234, createdAt: '2023-01-15T14:10:00Z' },
  { name: 'user-profiles', objectCount: 19876, size: 89012345678, createdAt: '2023-03-22T09:30:00Z' },
]);
