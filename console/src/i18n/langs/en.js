...
const en = {
  ...
  // 子账户管理页面
  user: {
    pageTitle: "Sub Account Management",
    createUser: "Create Sub Account",
    ...
    editUser: "Edit Sub Account",
    editSubAccount: "Edit Sub Account",
    deleteUser: "Delete Sub Account",
    delete: "Delete",
    noUsers: "No sub accounts found, please click the button above to create",
    noSubAccounts: "No Sub Accounts",
    searchPlaceholder: "Search user name or email...",
    confirmDeleteTitle: "Confirm Delete",
    confirmDelete: "Confirm Delete",
    confirmDeleteMessage:
      'Are you sure you want to delete sub account "{name}"? This action will also delete all access keys for this account.',
    createdSuccess: "Sub account created successfully!",
    updatedSuccess: "Sub account updated successfully!",
    deletedSuccess: "Sub account deleted successfully!",
    enableSuccess: "Sub account enabled successfully!",
    disableSuccess: "Sub account disabled successfully!",
    resetPassword: "Reset Password",
    confirmResetPasswordTitle: "Confirm Password Reset",
    confirmResetPasswordMessage:
      'Are you sure you want to reset the password for sub account "{name}"?',
    ...
    userDetails: "Sub Account Details",
    ...
    associatedSubAccountGroup: "Associated Sub Account Group",
    ...
    clickAddSubAccount: "Please click the button above to add",
